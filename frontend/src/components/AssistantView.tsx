...
export default function AssistantView() {
  ...
  return (
    // No heading or side padding of its own: the page header above already names the view,
    // and the content column already has the page's gutter - both were doubled here.
    <div className="flex flex-col gap-4 pb-10">
      {/* Kept even though the header describes the view: it is the disclosure that attack-path
          data leaves the trust boundary on every call. */}
