...
Everything here was in the README until it grew past two thousand lines, at which
point it stopped being a landing page without becoming a better manual. Same
content, addressable.

## Contents

- [The core idea](#the-core-idea) - what an attack path is, and how it is scored
- [Architecture](#architecture) - components, ontology, event contract, tech stack
- [Risk scoring](#risk-scoring) - the probability model in full, and its honesty layers
- [Quick start](#quick-start) - running it, feeding it, every integration
- [Container and compose hardening](#container--compose-hardening)
- [Deploy to Kubernetes](#deploy-to-kubernetes)
- [Operating it](#operating-it-freshness-backup--dr) - freshness, backup, DR
- [Onboarding runbook](#onboarding-runbook) - point it at your own environment
...
helm install perspective oci://ghcr.io/luiacuaniello/charts/perspectivegraph \
  ...
  --set opensearch.url="" \
  --version 1.12.6 # x-release-please-version
```
...
cosign verify \
  ...
  ghcr.io/luiacuaniello/charts/perspectivegraph:1.12.6 # x-release-please-version
```
