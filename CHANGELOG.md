...
* the merge gate and the engine's PR feedback count the routes a change opens ([#257](https://github.com/luiacuaniello/perspectivegraph/issues/257)) ([c2bbec6](https://github.com/luiacuaniello/perspectivegraph/commit/c2bbec6d2d2745a1da59af3c3bb46280979f14b6))
...
* a bounded event bus, event writes in one locked transaction, and a budget for heavy API analyses ([#251](https://github.com/luiacuaniello/perspectivegraph/issues/251)) ([25a4f0e](https://github.com/luiacuaniello/perspectivegraph/commit/25a4f0e138e01269b74a4be631dc603ac23f4a97))
...
* **deps:** patch the third-party images, and watch them from now on ([#176](https://github.com/luiacuaniello/perspectivegraph/issues/176)) ([c2abce6](https://github.com/luiacuaniello/perspectivegraph/commit/c2abce65883c1c43d2e7f6ca0f9ac599b7b90441))

## [1.12.3](https://github.com/luiacuaniello/perspectivegraph/compare/v1.12.2...v1.12.3) (2026-09-04)


### Bug Fixes

* **action:** bring the description under the Marketplace ceiling ([#174](https://github.com/luiacuaniello/perspectivegraph/issues/174)) ([bcc5375](https://github.com/luiacuaniello/perspectivegraph/commit/bcc537598d440659b983fd53bc83869104a1a56d))
...
* **helm:** install the app version the chart declares, and scan what it deploys ([#169](https://github.com/luiacuaniello/perspectivegraph/issues/169)) ([d8cf57a](https://github.com/luiacuaniello/perspectivegraph/commit/d8cf57a98235b175624851957e057270e788191d))

## [1.12.0](https://github.com/luiacuaniello/perspectivegraph/compare/v1.11.2...v1.12.0) (2026-09-04)


### Features

* run the demo from published images, and give the chart a page ([#167](https://github.com/luiacuaniello/perspectivegraph/issues/167)) ([4853a79](https://github.com/luiacuaniello/perspectivegraph/commit/4853a798f01fc1c517363dfe7297d23ccf11a354))
...
* **security:** harden the five findings of the offensive self-assessment ([#161](https://github.com/luiacuaniello/perspectivegraph/issues/161)) ([62c46b0](https://github.com/luiacuaniello/perspectivegraph/commit/62c46b0bc45e424b8c6bffabf2956f9f76975a0d))
...
* move governance state to Postgres and close two DoS/auth findings ([#129](https://github.com/luiacuaniello/perspectivegraph/issues/129)) ([7f2598b](https://github.com/luiacuaniello/perspectivegraph/commit/7f2598b2f3732c7c01c91c4651eb720664b14dbc))

## [1.4.3](https://github.com/luiacuaniello/perspectivegraph/compare/v1.4.2...v1.4.3) (2026-08-08)


### Bug Fixes

* refuse malformed k8s specs; make the chart admissible and self-healing ([#125](https://github.com/luiacuaniello/perspectivegraph/issues/125)) ([e8ac1ef](https://github.com/luiacuaniello/perspectivegraph/commit/e8ac1ef78cff1124ab51cce181f661ad0327560c))

## [1.4.2](https://github.com/luiacuaniello/perspectivegraph/compare/v1.4.1...v1.4.2) (2026-08-07)


### Bug Fixes

* **ci:** pick the binary for the runner's platform, not always linux ([#123](https://github.com/luiacuaniello/perspectivegraph/issues/123)) ([7061342](https://github.com/luiacuaniello/perspectivegraph/commit/7061342b8e86be78273e35d0647c45520a3274e0))
...
* **ci:** report unknown as unknown, and automate the floating major tag ([#117](https://github.com/luiacuaniello/perspectivegraph/issues/117)) ([b74cb44](https://github.com/luiacuaniello/perspectivegraph/commit/b74cb4402fb293e8d2848c30b3ca3fb2c641346b))

## [1.3.0](https://github.com/luiacuaniello/perspectivegraph/compare/v1.2.1...v1.3.0) (2026-08-07)


### Features

* **ci:** block pull requests on attack paths, and say when nobody looked ([#115](https://github.com/luiacuaniello/perspectivegraph/issues/115)) ([5e2c531](https://github.com/luiacuaniello/perspectivegraph/commit/5e2c5312616fac9a28b915f54808e9c7a4a1a112))
...
* **dashboard:** resolve the react-hooks warnings, and keep the one that is deliberate ([#91](https://github.com/luiacuaniello/perspectivegraph/issues/91)) ([d631348](https://github.com/luiacuaniello/perspectivegraph/commit/d631348f0ff532b17511bf847e870eccdca9d5c8))
...
* **calibration:** grade the engine on forecasts it made before the a… ([#79](https://github.com/luiacuaniello/perspectivegraph/issues/79)) ([2a6f872](https://github.com/luiacuaniello/perspectivegraph/commit/2a6f87213e35d2dff7ad0149bf74f4dd9be794aa))
