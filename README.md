...
```bash
docker pull ghcr.io/luiacuaniello/perspectivegraph:v0.8.0 # x-release-please-version
docker pull ghcr.io/luiacuaniello/perspectivegraph-dashboard:v0.8.0 # x-release-please-version
```
...
cosign verify \
  ...
  ghcr.io/luiacuaniello/perspectivegraph:v0.8.0 # x-release-please-version
```
...
**The benchmark, as of v0.8.0.** <!-- x-release-please-version --> `make bench-cloudgoat`
