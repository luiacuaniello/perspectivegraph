...
```bash
docker pull ghcr.io/luiacuaniello/perspectivegraph:v0.5.0 # x-release-please-version
docker pull ghcr.io/luiacuaniello/perspectivegraph-dashboard:v0.5.0 # x-release-please-version
```
...
cosign verify \
  ...
  ghcr.io/luiacuaniello/perspectivegraph:v0.5.0 # x-release-please-version
```
