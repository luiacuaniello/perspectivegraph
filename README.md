...
```bash
docker pull ghcr.io/luiacuaniello/perspectivegraph:v0.9.3 # x-release-please-version
docker pull ghcr.io/luiacuaniello/perspectivegraph-dashboard:v0.9.3 # x-release-please-version
```
...
cosign verify \
  --certificate-identity-regexp 'https://github.com/luiacuaniello/perspectivegraph/.*' \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  ghcr.io/luiacuaniello/perspectivegraph:v0.9.3 # x-release-please-version
```
...
**The benchmark, as of v0.9.3.** <!-- x-release-please-version --> `make bench-cloudgoat`
