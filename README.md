...
```bash
docker pull ghcr.io/luiacuaniello/perspectivegraph:v1.14.0 # x-release-please-version
docker pull ghcr.io/luiacuaniello/perspectivegraph-dashboard:v1.14.0 # x-release-please-version
docker pull ghcr.io/luiacuaniello/perspectivegraph-postgres:v1.14.0 # x-release-please-version
```
...
cosign verify \
  --certificate-identity-regexp 'https://github.com/luiacuaniello/perspectivegraph/.*' \
  --certificate-oidc-issuer https://token.actions.githubusercontent.com \
  ghcr.io/luiacuaniello/perspectivegraph:v1.14.0 # x-release-please-version
```
...
**The benchmark, as of v1.14.0.** <!-- x-release-please-version --> `make bench-cloudgoat`
